export default {
  UNREADMESSAGE_QUERYUNREAD: ['/UnreadMessage/queryunread', 'BASE_JML2', 'UMESSAGE_URL'], // 查询未读消息
  UNREADMESSAGE_UPDATEUNREAD: ['/UnreadMessage/updateunread', 'BASE_JML2', 'UMESSAGE_URL'], // 标记消息已读
