export default {
  ...
  get_buyerProductTradeList: ['/purchase/sku/history',  'UPURCHASE_URL'],
  ...
  get_warehouseOrderData: ['/order/skus',  'UPURCHASE_URL'],
  ...
  set_qcResultRework: ['/qc/rework',  'UPURCHASE_URL'],
  set_qcResultReturn: ['/qc/return',  'UPURCHASE_URL'],
  get_qcPaymentData: ['/payment/list/{orderNo}/{orderType}',  'UPURCHASE_URL'],
  get_qcPaymentNo: ['/payment/genNo',  'UPURCHASE_URL'],
  save_qcPayment: ['/payment/save',  'UPURCHASE_URL'],
  update_qcPayment: ['/payment/update',  'UPURCHASE_URL'],
  abandon_qcPayment: ['/payment/abandon/{id}?version={version}',  'UPURCHASE_URL'],
  recover_qcPayment: ['/payment/recover/{id}?version={version}',  'UPURCHASE_URL'],
