export default {
  ...
  //product buyer
  get_buyerProductList: ['/purchase/sku/listSkuByParams','BASE_CS','BASE_URL'],
  get_buyerBookmarkList: ['/purchase/sku/listBookmark', 'BASE_CS','BASE_URL'],
  add_buyerBookmark: ['/purchase/sku/bookmark', 'BASE_CS','BASE_URL'],
  ...
  delete_buyerProductBookmark: ['/purchase/sku/deleteBookmark','BASE_URL','BASE_URL'],
  add_customerSku: ['/purchase/sku/addCustomerSku','BASE_CS', 'BASE_URL'],
  get_compareList: ['/purchase/sku/listCompare', 'BASE_URL'],
  get_skuListByIds: ['/purchase/sku/listSkuByIds','BASE_CS','BASE_URL'],
  ...
  get_buyerProductCompareDetail: ['/purchase/sku/listCompareDetails', 'BASE_CS','BASE_URL'],
  delete_buyerProductCompare: ['/purchase/sku/deleteCompare', 'BASE_URL'],
  get_buyerProductDetail: ['/purchase/sku/{id}', 'BASE_CS','BASE_URL'],
