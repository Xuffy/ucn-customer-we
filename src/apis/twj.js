export default {
  ...
  //companyInfo
  get_purchase_supplier: ['/purchase/supplier/{id}', 'BACE_CS'],
  post_purchase_customer: ['/purchase/customer', 'BACE_CS'],
  post_purchase_customer_address_id: ['/purchase/customer/address', 'BACE_CS'],
  post_purchase_customer_address: ['/purchase/customer/address', 'BACE_CS'],
  get_purchase_customer_getCustomer: ['/purchase/customer/getCustomer', 'BACE_CS'],
  post_purchase_customer_deleteAddress: ['/purchase/customer/deleteAddress/{id}', 'BACE_CS'],
  post_purchase_customer_concat: ['/purchase/customer/concat', 'BACE_CS'],
  post_purchase_customer_concat_id: ['/purchase/customer/concat', 'BACE_CS'],
  post_purchase_customer_deleteConcat: ['/purchase/customer/deleteConcat/{id}', 'BACE_CS'],
  post_purchase_customer_custom: ['/purchase/customer/custom', 'BACE_CS'],
  post_purchase_customer_custom_id: ['/purchase/customer/custom', 'BACE_CS'],
  post_purchase_customer_deleteCustom: ['/purchase/customer/deleteCustom/{id}', 'BACE_CS'],
  post_purchase_customer_document: ['/purchase/customer/document', 'BACE_CS'],
  post_purchase_customer_document_id: ['/purchase/customer/document', 'BACE_CS'],
  post_purchase_customer_deleteDocument: ['/purchase/customer/deleteDocument/{id}', 'BACE_CS'],
  post_oss_company_batchUpload: ['/purchase/oss/company/batchUpload', 'BACE_CS'],
  post_oss_company_upload: ['/purchase/oss/company/upload', 'BACE_CS'],
  post_purchase_customer_updateIsSetting:['/purchase/customer/updateIsSetting/{id}', 'BACE_CS'],
