...
export default {
    ...
    post_supplier_delete_remark: ['/purchase/supplier/deleteRemark/{id}',  'BASE_URL'],
    post_listSupplierByIds: ['/purchase/supplier/listSupplierByIds',  'BASE_URL'],
    post_supplier_addbookmark: ['/purchase/supplier/bookmark',  'BASE_URL'],
    post_supplier_deletebookmark: ['/purchase/supplier/deleteBookmark/{id}',  'BASE_URL'],
    post_supplier_listbookmark: ['/purchase/supplier/listBookmarks',  'BASE_URL'],
    post_supplier_recoverbookmark: ['/purchase/supplier/recoverBookmark/{id}',  'BASE_URL'],
    post_supplier_addCompare: ['/purchase/supplier/compare',  'BASE_URL'],
    post_supplier_listCompare: ['/purchase/supplier/listCompare', 'BASE_URL'],
    post_supplier_listCompareDetails: ['/purchase/supplier/listCompareDetails', 'BASE_URL'],
    post_supplier_deleteCompareDetails: ['/purchase/supplier/deleteCompareDetails', 'BASE_URL'],
    post_supplier_deleteCompare: ['/purchase/supplier/deleteCompare', 'BASE_URL'],
    post_supplier_recoverCompare: ['/purchase/supplier/recoverCompare', 'BASE_URL'],
    post_deleteBookmarks: ['/purchase/supplier/batchDeleteBookmark', 'BASE_URL'],
    post_recoverBookmarks: ['/purchase/supplier/batchRecoverBookmark', 'BASE_URL'],
    post_purchase_supplier_orderHistory: ['/purchase/supplier/orderHistory', 'BASE_URL'],
    post_purchase_supplier_getInquiryHistory: ['/purchase/supplier/getInquiryHistory', 'BASE_URL'],
    post_purchase_supplier_listRemarks: ['/purchase/supplier/listRemarks', 'BASE_URL'],
    post_purchase_supplier_remark: ['/purchase/supplier/remark', 'BASE_URL'],
    post_purchase_supplier_remark_id: ['/purchase/supplier/remark', 'BASE_URL'],
    post_purchase_supplier_deleteRemark_id: ['/purchase/supplier/deleteRemark/{id}', 'BASE_URL'],
