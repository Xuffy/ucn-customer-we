...
export default {
    ...
    //supplier
    post_add_supplier_remark: ['/purchase/supplier/remark',  'BASE_CS'],
    get_update_supplier_remark: ['/purchase/supplier/remark/{id}',  'BASE_CS'],
    get_listSupplier: ['/purchase/listSupplier',  'BASE_CS'],
    get_supplier_id: ['/purchase/supplier/{id}', 'BASE_CS'],
    post_supplier_list_remark: ['/purchase/supplier/listRemarks',  'BASE_CS'],
    post_supplier_remark: ['/purchase/supplier/remark',  'BASE_CS'],
    get_supplier_remark_de: ['/purchase/supplier/remark/{id}',  'BASE_CS'],
    post_supplier_delete_remark: ['/purchase/supplier/deleteRemark/{id}',  'BASE_CS'],
    post_listSupplierByIds: ['/purchase/supplier/listSupplierByIds',  'BASE_CS'],
    post_supplier_addbookmark: ['/purchase/supplier/bookmark',  'BASE_CS'],
    post_supplier_deletebookmark: ['/purchase/supplier/deleteBookmark/{id}',  'BASE_CS'],
    post_supplier_listbookmark: ['/purchase/supplier/listBookmarks',  'BASE_CS'],
    post_supplier_recoverbookmark: ['/purchase/supplier/recoverBookmark/{id}',  'BASE_CS'],
    post_supplier_addCompare: ['/purchase/supplier/compare',  'BASE_CS'],
    post_supplier_listCompare: ['/purchase/supplier/listCompare', 'BASE_CS'],
    post_supplier_listCompareDetails: ['/purchase/supplier/listCompareDetails', 'BASE_CS'],
    post_supplier_deleteCompareDetails: ['/purchase/supplier/deleteCompareDetails', 'BASE_CS'],
    post_supplier_deleteCompare: ['/purchase/supplier/deleteCompare', 'BASE_CS'],
    post_supplier_recoverCompare: ['/purchase/supplier/recoverCompare', 'BASE_CS'],
    post_deleteBookmarks: ['/purchase/supplier/batchDeleteBookmark', 'BASE_CS'],
    post_recoverBookmarks: ['/purchase/supplier/batchRecoverBookmark', 'BASE_CS'],
    post_purchase_supplier_orderHistory: ['/purchase/supplier/orderHistory', 'BASE_CS'],
    post_purchase_supplier_getInquiryHistory: ['/purchase/supplier/getInquiryHistory', 'BASE_CS'],
    post_purchase_supplier_listRemarks: ['/purchase/supplier/listRemarks', 'BASE_CS'],
    post_purchase_supplier_remark: ['/purchase/supplier/remark', 'BASE_CS'],
    post_purchase_supplier_remark_id: ['/purchase/supplier/remark', 'BASE_CS'],
    post_purchase_supplier_deleteRemark_id: ['/purchase/supplier/deleteRemark/{id}', 'BASE_CS'],
