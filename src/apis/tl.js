export default {
    ...
    */
   //采购端
    POST_INQIIRY_LIST: ['/inquiry/list', 'BASE_DHC', 'UPURCHASE_URL'], // 采购端=> inquiry list
    ...
    ITEMFAVORITE_PART: ['/itemfavorite/part', 'UPURCHASE_URL', 'USUPPLY_URL'],
    ITEMFAVORITE_UPDATE: ['/itemfavorite/update', 'UPURCHASE_URL', 'USUPPLY_URL'],
    POST_CODE_PART: ['/code/part', 'UPURCHASE_URL', 'USUPPLY_URL'],
    POST_LOGISTICSPORT_QUERY: ['/logisticsport/query', 'UPURCHASE_URL', 'USUPPLY_URL'],
    GET_COUNTRY_ALL: ['/country/all', 'UPURCHASE_URL', 'USUPPLY_URL'],
    //供应端
