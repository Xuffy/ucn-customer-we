<template>
  <div>
    ...
    <el-row :gutter="10">
      <el-form ref="ruleForm" label-width="300px" label-position="right" class="form" >
        <el-col :xs="gap" :sm="gap" :md="gap" :lg="gap" :xl="gap" v-for="a of listData" :key="'el-col-' + a.label">
          ...
          <div v-else>
            <el-form-item :label="a.label+'：'" v-if="a.type === 'input'">
              <el-input placeholder="请输入内容" v-model="a.value" :disabled="a.disabled" />
            </el-form-item>

            <el-form-item :label="a.label+'：'" v-if="a.type === 'selector'">
            ...
            <el-form-item :label="a.label+'：'" v-if="a.type === 'date'">
